...
Each critical peripheral shall have a gigabit ethernet interface and its own microkernel in order to provide real-world separation. All network peripherals, except a standard wifi interface, shall be made with FPGAs in order to provide long lasting support.
...
A PCI express interface with an USB 4.0 connector will allow developers to plug a GSM modem.
